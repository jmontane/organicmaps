...
void RoutingManager::GenerateNotifications(vector<string> & turnNotifications, bool shouldAnnounceStreetNames)
{
  m_routingSession.GenerateNotifications(turnNotifications, shouldAnnounceStreetNames);
}
